...
module JsonTypes =
    ...
    type JCar =
        { [<DataMember(EmitDefaultValue = false)>]
          ...
          frames: JFrames
          [<DataMember(EmitDefaultValue = false)>]
          isPoweredRideWithUnrestrictedGravity: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasNoUpstopWheels: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasNoUpstopWheelsBobsleigh: bool
          [<DataMember(EmitDefaultValue = false)>]
          isMiniGolf: bool
          [<DataMember(EmitDefaultValue = false)>]
          isReverserBogie: bool
          [<DataMember(EmitDefaultValue = false)>]
          isReverserPassengerCar: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasInvertedSpriteSet: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasDodgemInUseLights: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasAdditionalColour2: bool
          [<DataMember(EmitDefaultValue = false)>]
          recalculateSpriteBounds: bool
          [<DataMember(EmitDefaultValue = false)>]
          VEHICLE_ENTRY_FLAG_11: bool
          [<DataMember(EmitDefaultValue = false)>]
          overrideNumberOfVerticalFrames: bool
          [<DataMember(EmitDefaultValue = false)>]
          spriteBoundsIncludeInvertedSet: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasAdditionalSpinningFrames: bool
          [<DataMember(EmitDefaultValue = false)>]
          isLift: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasAdditionalColour1: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasSwinging: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasSpinning: bool
          ...
          isPowered: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasScreamingRiders: bool
          [<DataMember(EmitDefaultValue = false)>]
          useSuspendedSwing: bool
          [<DataMember(EmitDefaultValue = false)>]
          useBoatHireCollisionDetection: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasVehicleAnimation: bool
          [<DataMember(EmitDefaultValue = false)>]
          hasRiderAnimation: bool
          [<DataMember(EmitDefaultValue = false)>]
          useWoodenWildMouseSwing: bool
          [<DataMember(EmitDefaultValue = false)>]
          useSlideSwing: bool
          [<DataMember(EmitDefaultValue = false)>]
          isChairlift: bool
