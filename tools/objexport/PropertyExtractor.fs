...
module PropertyExtractor =
    ...
    let getCar (ride: Attraction) (car: CarHeader) (loadingPositionsRaw: byte[] option) =
        ...
        { rotationFrameMask = int rotationFrameMask
          ...
          frames = frames
          VEHICLE_ENTRY_FLAG_POWERED_RIDE_UNRESTRICTED_GRAVITY = hasFlag 0
          ...
          VEHICLE_ENTRY_FLAG_DODGEM_INUSE_LIGHTS = hasFlag 7
          ...
          VEHICLE_ENTRY_FLAG_SPINNING_ADDITIONAL_FRAMES = hasFlag 14
          VEHICLE_ENTRY_FLAG_LIFT = hasFlag 15
          ...
          VEHICLE_ENTRY_FLAG_BOAT_HIRE_COLLISION_DETECTION = hasFlag 22
